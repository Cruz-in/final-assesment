...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderSearchResults(query) {
    ...
    if (matches.length === 0) {
      ...
      li.innerHTML = `<span class="body-large" style="color: var(--border-color); display: block; padding: 1.5rem 2rem;">[ NO SYSTEM LOGS MATCHED ]</span>`;
...
new LiquidGradient("fluid-lab", false);
